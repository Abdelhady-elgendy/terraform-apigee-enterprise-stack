...
variable "primary_region" {
  type        = string
  description = "Primary Apigee instance region."
  default     = "us-central1"
}

variable "secondary_region" {
  type        = string
  description = "Secondary Apigee instance region."
  default     = "us-east1"
}
...
variable "primary_instance_name" {
  type        = string
  description = "Primary runtime instance name."
  default     = "apigee-runtime-primary"
}

variable "secondary_instance_name" {
  type        = string
  description = "Secondary runtime instance name."
  default     = "apigee-runtime-secondary"
}
